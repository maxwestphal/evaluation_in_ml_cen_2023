---
title: "Model and Algorithm Evaluation in Supervised Machine Learning" 
subtitle: "Short Course at CEN 2023 Conference"
date: 2023-09-03
...
format: 
  revealjs:
    ...
    footer: "Max Westphal & Rieke Alpers &nbsp; - &nbsp; Model and Algorithm Evaluation in Supervised Machine Learning &nbsp; - &nbsp; Short Course at CEN  2023 Conference &nbsp; - &nbsp; 2023-09-03 "
    margin: 0.1
filters: 
  - search-replace
search-replace:
  ...
  ++true: "{{< fa solid circle-check >}} \ " # hands-on session
  ++false: "{{< fa regular circle-xmark >}} \ " # hands-on session
...
-   {{< fa brands github >}} Slides & reproducible code
    -   <https://github.com/maxwestphal/evaluation_in_supervised_ml_cen_2023>
...
5. ++ds Data splitting $\longrightarrow$ ++is $\longrightarrow$ ++que
6. ++sa Statistical analysis $\longrightarrow$ ++is $\longrightarrow$ ++que
7. ++pa Practical aspects $\longrightarrow$ ++is $\longrightarrow$ ++que
8. ++wu Wrap-up 
...
- only evaluate each model once ++true
...
- overfitting and selection-induced bias ++true
- underfitting and selection-induced bias ++false
- overfitting, underfitting and selection-induced bias ++false
...
- multil-label classification ++false
...
![](figures/bmdeep_multiclass_1.png)


## Multi-class classification: cost-sensitive metrics (BMDeep)

![](figures/bmdeep_multiclass_2.png)
...
- predicted probabilities relative to observed class labels ++false
...
- only sensitivty OR specifity should be considered, not both ++false
- overall accuracy is independed of class prevalences ++false
- balanced accuracy can be calculated from the confusing matrix ++false
- balanced accuracy can be calculated from the confusion matrix ++true
...
- for resampling / data splitting ++false
...
<!-- - <https://wlandau.github.io/targets-tutorial/#1> -->
:::
...
<!-- -   overview paper (see also PhD thesis) -->
...
- ++pm Calibration is usually harder to achieve than discrimination.
...
- ++pa Evaluation should guide/support development.

## Contact

-   {{< fa envelope >}} [max.westphal\@mevis.fraunhofer.de](mailto:max.westphal@mevis.fraunhofer.de)
-   {{< fa envelope >}} [rieke.alpers\@mevis.fraunhofer.de](mailto:rieke.alpers@mevis.fraunhofer.de)
    -   Feedback
    -   Further questions
    -   Collaboration requests
-   {{< fa brands twitter >}} \@MaxWestphal89
    -   Get/stay in touch
-   {{< fa brands github >}}  <https://github.com/maxwestphal/evaluation_in_supervised_ml_cen_2023/issues>
...
# Thank you for your participation! \n Have a great conference! {{< fa regular face-smile >}}
